...
// Magazine / reader subscription plans
const MAGAZINE_PLANS = {
  digest_reader: { name: 'Capital Digest Reader', price_monthly: 999, price_annual: 9900 },
  digest_pro: { name: 'Capital Digest Pro', price_monthly: 1999, price_annual: 19900 },
};
...
Deno.serve(async (req) => {
  try {
    ...
    // Determine plan config from either set
